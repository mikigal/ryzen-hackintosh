...
## How to use
  ...
  10. To fix not working apps (e. g. Discord voice chat) download and run [**ryzen_patch.sh**](/Resources/adobe_patch.sh). When patching is done remember to reboot your Hackintosh.
