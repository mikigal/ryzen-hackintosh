...
2. Update OpenCore and kexts to latest build (you can get it from AMD-OSX Discord or built it manually). Remember to update config.plist too (read Differences.pdf from OpenCore package)
